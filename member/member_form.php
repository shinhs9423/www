        ...
        <form name="member_form" method="post" action="insert.php">
            <ul>
                <li>
                    ...
                    <input type="text" name="id" id="id" required maxlength="15" placeholder="아이디를 입력하세요">
                    <div id="loadtext"></div>
                </li>
                ...
                <li>
                    ...
                    <input type="text" name="nick" id="nick" required placeholder="닉네임을 입력하세요">
                ...
                <li>
                    ...
                    <div class="ph_input">
                        ...
                        <span>-</span><label class="hidden" for="hp2">전화번호중간4자리</label><input type="text" class="hp" name="hp2" id="hp2" required>
                        <span>-</span><label class="hidden" for="hp3">전화번호끝4자리</label><input type="text" class="hp" name="hp3" id="hp3" required>
                    </div>
                </li>
                <li>
                    <h3>
                    ...
                    <div class="email_area">
                        ...
                        <input type="text" name="email2" id="email2" required placeholder="도메인 주소">
                    </div>
                </li>
            </ul>
