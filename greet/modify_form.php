...
<!-- visual -->
	...
	<div class="sub_menu">
		<ul>
			...
			<li><a href="./sub4_2.html">홍보자료</a></li>
		</ul>
	</div>
	...
	<article id="content">
		...
		<form name="board_form" method="post" action="insert.php?mode=modify&num=<?=$num?>&page=<?=$page?>" id="insert">

			<dl>
				<dt><label class="hidden" for="subject">제목</label><input type="text" name="subject" value="<?=$item_subject?>" placeholder="제목을 입력해주세요"></dt>
