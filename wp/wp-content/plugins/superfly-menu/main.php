...
function check_against_rule($first_level, $sec_level, $post_id = false)
{
    ...
    if (gettype($locations) == 'object') { /* migration */
        foreach ($locations as $menu_object) {
            ...
            if (isset($current_loc->pages) && !count(get_object_vars($current_loc->pages)) &&
                isset($current_loc->cposts) && !count(get_object_vars($current_loc->cposts)) &&
                isset($current_loc->cats) && !count(get_object_vars($current_loc->cats)) &&
                isset($current_loc->taxes) && !count(get_object_vars($current_loc->taxes)) &&
                isset($current_loc->wp_pages) && !count(get_object_vars($current_loc->wp_pages)) &&
